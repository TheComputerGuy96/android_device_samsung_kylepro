...
/** The value of 'pseudorange rate' is uncorrected. */#define GPS_MEASUREMENT_HAS_UNCORRECTED_PSEUDORANGE_RATE         (1<<18)
...
#pragma pack(push,4)
// We need to keep the alignment of this data structure to
// 4-bytes, to ensure that in 64-bit environments the size of
// this legacy definition does not collide with _v2.
// Implementations should be using _v2 and _v3, so it's OK
// to pay the 'unaligned' penalty in 64-bit if an old
